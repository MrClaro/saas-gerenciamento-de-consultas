...
const formSchema = z
  .object({
    ...
    appointmentPrice: z.number().min(1, "O preço da consulta é obrigatório"),
...
const UpsertDoctorForm = ({ doctor, onSuccess }: UpsertDoctorFormProps) => {
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      availableFromTime: doctor?.availableFromTime || "09:00",
  ...
  const upsertDoctorAction = useAction(upsertDoctor, {
    ...
    onError: (error) => {
      toast.error(
        `Erro: ${error.error.serverError || "Ocorreu um erro ao adicionar o médico"}`,
      );
    },
  });
      ...
      <DialogHeader>
        ...
        <DialogDescription>
          {doctor
            ...
            : "Preencha as informações do médico abaixo."}
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
